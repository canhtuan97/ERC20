...
contract WWWToken {
    ...
    function WWWToken(
        ...
        balanceOf[manager] = totalSupply;                        // Give the creator all initial tokens
     ...
     */
    function approveAndCall(address spender, uint256 value, bytes _extraData)
        public
        returns (bool success) {
